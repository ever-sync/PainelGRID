...
export class IntegrationCredentialsController {
  ...
  @Get()
  @ApiOperation({ summary: 'Lista credenciais de integracao sem expor os segredos' })
  list(
  ...
  @Post()
  @ApiOperation({ summary: 'Cria credencial; o segredo e retornado somente nesta resposta' })
  create(
    @CurrentUser() user: AuthenticatedUser,
    @Param('clientId', new ParseUUIDPipe()) clientId: string,
