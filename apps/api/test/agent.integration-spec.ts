...
describe('Agent routes (integration)', () => {
  ...
  async function createApp() {
    ...
    const moduleRef = await Test.createTestingModule({
      ...
      providers: [
        ...
        { provide: ConversationStateService, useValue: conversationStateService },
      ],
    }).compile();
    ...
    return { app, agentService, agentActionLogService, conversationStateService };
  }
  ...
  it('GET /agent/events/availability sem chave retorna 401', async () => {
    ...
    await request(app.getHttpServer()).get('/api/agent/events/availability').expect(401);
  ...
  it('POST /agent/conversations/:id/state persiste estado operacional', async () => {
    ...
    await request(app.getHttpServer())
      .post('/api/agent/conversations/33333333-3333-4333-8333-333333333333/state')
      .set('X-Leadflow-Integration-Key', apiKey)
      .send(payload)
      .expect(201);
  ...
  it('POST /agent/conversations/:id/action-logs registra auditoria do agente', async () => {
    ...
    await request(app.getHttpServer())
      .post('/api/agent/conversations/33333333-3333-4333-8333-333333333333/action-logs')
      .set('X-Leadflow-Integration-Key', apiKey)
      .send(payload)
      .expect(201);
  ...
  it('POST /agent/conversations/:id/handoff abre handoff formal', async () => {
    ...
    await request(app.getHttpServer())
      .post('/api/agent/conversations/33333333-3333-4333-8333-333333333333/handoff')
      .set('X-Leadflow-Integration-Key', apiKey)
      .send(payload)
      .expect(201);
