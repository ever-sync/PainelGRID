...
export class ServiceRatingsController {
  ...
  @Get('summary')
  @Roles(Role.VENDEDOR)
  @ApiOperation({ summary: 'Retorna resumo de avaliacoes de atendimento do vendedor' })
  ...
  @Get('vendor/:vendorId')
  @Roles(Role.GESTOR)
  @ApiOperation({ summary: 'Retorna perfil completo de avaliacoes/metricas de um vendedor' })
  @ApiResponse({ status: 200, description: 'Perfil retornado com sucesso' })
  @ApiResponse({ status: 403, description: 'Sem permissao sobre este vendedor' })
  ...
  async vendorProfile(
    ...
    await this.clientsService.assertGestorOwnsClient(user.sub, vendor.client_id);
