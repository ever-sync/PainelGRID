...
describe("EventsService", () => {
        ...
        expect.objectContaining({
          where: {
            participants: {
              some: {
                client_id: {
                  in: [clientId, "22222222-2222-4222-8222-222222222222"],
                },
              },
            },
          },
  ...
  describe("findOne", () => {
    ...
    it("lanca NotFoundException quando evento nao existe", async () => {
      ...
      await expect(
        service.findOne(gestorUser, "inexistente"),
  ...
  describe("update", () => {
    ...
    it("lanca NotFoundException quando evento nao existe", async () => {
      ...
      await expect(
        service.update(gestorUser, "nope", {} as never),
      ).rejects.toBeInstanceOf(NotFoundException);
    });
  ...
  describe("remove", () => {
    ...
    it("lanca NotFoundException quando evento nao existe", async () => {
      ...
      await expect(service.remove(gestorUser, "nope")).rejects.toBeInstanceOf(
        NotFoundException,
      );
    });
  });
