...
export class EventsService {
  ...
  private serializeEvent(row: EventRow) {
    ...
    return {
      ...
      allow_vendor_checkin: row.allow_vendor_checkin ?? false,
      allow_vendor_fipe: row.allow_vendor_fipe ?? false,
      allow_vendor_create_sale: row.allow_vendor_create_sale ?? false,
      allow_vendor_edit_sale: row.allow_vendor_edit_sale ?? false,
      allow_vendor_delete_sale: row.allow_vendor_delete_sale ?? false,
      allow_vendor_edit_own_lead: row.allow_vendor_edit_own_lead ?? false,
      ...
      allow_reception_quick_create: row.allow_reception_quick_create ?? false,
      total_investment:
  ...
  async create(user: AuthenticatedUser, dto: CreateEventDto) {
    ...
    const row = await this.prisma.event.create({
      data: {
        ...
        allow_vendor_checkin: dto.allow_vendor_checkin ?? false,
        allow_vendor_fipe: dto.allow_vendor_fipe ?? false,
        allow_vendor_create_sale: dto.allow_vendor_create_sale ?? false,
        allow_vendor_edit_sale: dto.allow_vendor_edit_sale ?? false,
        allow_vendor_delete_sale: dto.allow_vendor_delete_sale ?? false,
        allow_vendor_edit_own_lead: dto.allow_vendor_edit_own_lead ?? false,
        ...
        allow_reception_quick_create: dto.allow_reception_quick_create ?? false,
