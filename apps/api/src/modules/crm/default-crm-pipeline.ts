...
export const DEFAULT_CRM_STAGES: readonly DefaultCrmStageDef[] = [
  ...
  {
    suffix: 'CONF_PRE_AGENDAMENTO',
    name: 'Conf. Pré-agendamento',
    order: 6,
    color: '#818CF8',
    is_final_stage: false,
  },
  ...
  { suffix: 'LEMBRETE', name: 'Lembrete', order: 12, color: '#06B6D4', is_final_stage: false },
  {
  ...
  { suffix: 'AGUARDANDO', name: 'Aguardando', order: 17, color: '#A78BFA', is_final_stage: false },
  {
