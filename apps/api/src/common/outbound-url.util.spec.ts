import { assertSafeWebhookUrl, resolveSafeWebhookDestination } from './outbound-url.util';
...
describe('assertSafeWebhookUrl', () => {
  ...
  it('aceita e normaliza HTTPS com DNS publico', async () => {
    await expect(
      assertSafeWebhookUrl(' https://hooks.example.com/path#fragment ', publicDns),
  ...
  it('retorna o IP publico validado para ser fixado na conexao', async () => {
    await expect(
      resolveSafeWebhookDestination('https://hooks.example.com/webhook', publicDns),
