...
export class VendorScoreController {
  ...
  async ranking(
    ...
    const clientId = await this.resolveClientIdForRanking(user, query.client_id);
  ...
  private async resolveClientIdForRanking(user: AuthenticatedUser, queryClientId?: string) {
