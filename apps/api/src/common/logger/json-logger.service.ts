...
export class JsonLogger extends ConsoleLogger {
  ...
  protected printMessages(messages: unknown[], context?: string, level: LogLevel = 'log'): void {
    if (!this.jsonMode) {
  ...
  private toJsonEntry(message: unknown, context: string | undefined, level: LogLevel) {
